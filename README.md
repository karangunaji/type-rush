...
This app requires Supabase environment variables for authentication and data access.
...
When deploying, set `NEXT_PUBLIC_SUPABASE_URL` and `NEXT_PUBLIC_SUPABASE_ANON_KEY` in your project environment settings.
